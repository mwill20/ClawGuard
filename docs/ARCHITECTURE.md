...
The current Phase 1 architecture focuses on ASI06 job-description content detection plus ASI01 goal-redirect classification:
...
| Detector boundary | Job text and apply URLs | ASI06 and ASI01 detector rules | Evidence-preserving findings |
