...
|---|---|---|
| Unit tests | Confirms ASI01/ASI02/ASI06 detectors, runtime, parser, evaluation, telemetry validation, runtime-event contract validation, runtime-event writer behavior, review-session selection, export redaction, profile privacy override, and DB behavior | 61/61 passing |
