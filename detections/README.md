...
| JD Content Detection | ASI06 | Detector module implemented, runtime inline |
...
- `asi06_jd_content/detector.py` is the first importable ClawGuard detection engine module.
...
ASI06 remains inline in OpenClaw until a deploy-safe integration pass, but the ClawGuard detector module now preserves the runtime contract independently.
