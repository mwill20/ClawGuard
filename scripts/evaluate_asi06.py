#!/usr/bin/env python3
"""Evaluate ASI06 detector output against a labeled JSON fixture set."""
...
from detections.asi06_jd_content.detector import detect_job_content  # noqa: E402
...
def _score_counts(records: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for record in records:
        ...
        predicted = {finding.rule_id for finding in detect_job_content(record)}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Evaluate ASI06 detector against labeled fixtures.")
    parser.add_argument("--input", default="examples/asi06_labeled_eval.json")
