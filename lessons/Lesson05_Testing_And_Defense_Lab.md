...
| Telemetry sample | `examples/telemetry_sample.json` |
| Runtime event contract fixture | `examples/runtime_events_minimal.json` |
| Current total | 87 tests (31 in `test_job_search_secure.py`, 56 across detector / evaluation / telemetry / runtime-event contract and writer / selector / redaction-export / host annotation / runtime-event export / normal-ops fixture validation) |
